...
typedef errno_t Stack_error_t;
#define STACK_CANARY_SPOILED             0B1
#define STACK_INVALID                    0B10
#define STACK_NULL_CAPACITY              0B100
#define STACK_SIZE_GREATER_THAN_CAPACITY 0B1000
#define STACK_NULL_BUFFER                0B10000
#define STACK_BUFFER_CANARY_SPOILED      0B100000
#define STACK_BUFFER_SPOILED             0B1000000 //TODO -
Stack_error_t My_stack_verify(My_stack const *stack_ptr);
...
void My_stack_dump(FILE *out_stream, My_stack const *stack_ptr,
                   Position_info from_where, Stack_error_t err);
